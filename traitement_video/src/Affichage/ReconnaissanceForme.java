...
public class ReconnaissanceForme extends Thread {
	...
	public ReconnaissanceForme(int iter, int unit, String exec, String resp, int period, int prio,int dim) {
...
//		RtMgr.setSchedThreadParams(this, p);
		...
		Size sz = new Size(task.dim, task.dim);
		int i = 0;
	...
	public static void main(String[] args) {
		...
		int prio = 0;
		int dim = 1600;
		String exec_path = "exec-cam-rec-it-1000-per-100-prio-" + prio + "-dim-" + dim;
		String resp_path = "resp-cam-rec-it-1000-per-100-prio-" + prio + "-dim-" + dim;

		new ReconnaissanceForme(iteration, unittime, "rec/" + exec_path, "rec/" + resp_path, period_millis, prio,dim);
	}
}